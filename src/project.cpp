 ...
 * @param randomSeed the seed used to create a random number.  Pay attention to 
 ...
 * @return int random number generated by the given parameters and current state of seed
 */
